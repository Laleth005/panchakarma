  ...
  static List<TherapySessionModel> getTodaySessions(String practitionerId) {
    ...
    return [
      TherapySessionModel(
        ...
        specialInstructions: ['Use gentle pressure on lower back', 'Use extra sesame oil'],
      ),
      TherapySessionModel(
        id: 'session2',
        patientId: 'patient2',
        ...
        dateTime: DateTime(today.year, today.month, today.day, 10, 30), // 10:30 AM
        durationMinutes: 45,
        roomNumber: '102',
        bedNumber: '2',
      ...
      TherapySessionModel(
        ...
        therapyType: 'Swedana',
        dateTime: DateTime(today.year, today.month, today.day, 13, 0), // 1:00 PM
        durationMinutes: 30,
        roomNumber: '103',
        bedNumber: '1',
      ...
      TherapySessionModel(
        ...
        dateTime: DateTime(today.year, today.month, today.day, 14, 30), // 2:30 PM
        durationMinutes: 90,
        roomNumber: '104',
        bedNumber: '3',
        status: SessionStatus.pending,
        ...
        practitionerName: 'Dr. Ayurveda',
        hasSpecialInstructions: true,
        specialInstructions: ['Check for oil allergies', 'Use medium temperature'],
      ),
      TherapySessionModel(
        id: 'session5',
        patientId: 'patient5',
        ...
        dateTime: DateTime(today.year, today.month, today.day, 16, 0), // 4:00 PM
        durationMinutes: 75,
        roomNumber: '101',
        bedNumber: '2',
        status: SessionStatus.pending,
