...
class AuthGuard {
  ...
  static Future<bool> hasRole(BuildContext context, UserRole requiredRole) async {
  ...
  static Future<void> _redirectBasedOnRole(BuildContext context, UserRole? role) async {
    if (role == null) {
      _redirectToLogin(context);
      return;
    }
